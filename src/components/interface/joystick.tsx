...
export default function Joystick() {
  ...
  useEffect(() => {
    ...
    nipple.on("move", (_, data) => {
      ...
      if (force > 0.5) {
        setDirection({
          right: angle.degree <= 60 || angle.degree >= 300 ? true : false,
          left: angle.degree > 120 && angle.degree < 240 ? true : false,
          up: angle.degree >= 30 && angle.degree <= 150 ? true : false,
          down: angle.degree > 210 && angle.degree <= 330 ? true : false,
        });
      }
    });
