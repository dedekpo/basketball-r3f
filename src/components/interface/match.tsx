...
export default function Match() {
  ...
  const [gameStatus, setGameStatus] = useState<
    "Begin" | "Running" | "Stopped" | "Transition"
  >("Stopped");
  ...
  const gameSeconds = (gameTime % 60 >= 0 ? gameTime % 60 : 60).toLocaleString(
    undefined,
    {
  ...
  return (
    <div>
      {gameMode === "tournament" &&
        ((tournamentRound === 1 && !isGameRunning) ||
          gameStatus === "Stopped") && (
              ...
              <div className="absolute w-full h-[50%] mt-[50px] lg:mt-[100px] text-sm text-center">
                <div className="flex justify-between h-full">
                  <div className="w-full flex flex-col justify-evenly items-center">
                    ...
                    <PlayerBracket name="Ethan" round={1} lostRound={1} />
                    <PlayerBracket name="Liam" round={1} lostRound={1} />
                    <PlayerBracket name="Noah" round={1} lostRound={2} />
                    <PlayerBracket name="Lucas" round={1} lostRound={3} />
                    <PlayerBracket name="Aiden" round={1} lostRound={1} />
                    <PlayerBracket name="Carter" round={1} lostRound={2} />
                    <PlayerBracket name="Harper" round={1} lostRound={1} />
                  </div>
                  <div className="w-full flex flex-col justify-evenly items-center">
                    <PlayerBracket name="Player 1" round={2} />
                    <PlayerBracket name="Noah" round={2} lostRound={2} />
                    <PlayerBracket name="Lucas" round={2} lostRound={3} />
                    <PlayerBracket name="Carter" round={2} lostRound={2} />
                  </div>
                  <div className="w-full flex flex-col justify-evenly items-center">
                    <PlayerBracket name="Player 1" round={3} />
                    <PlayerBracket name="Lucas" round={3} lostRound={3} />
                  </div>
                  <div className="w-full flex flex-col justify-evenly items-center">
                    <PlayerBracket name="Player 1" round={4} />
                  </div>
                  <div className="w-full flex flex-col justify-evenly items-center">
                    <PlayerBracket name="Mason" round={4} lostRound={4} />
                  </div>
                  <div className="w-full flex flex-col justify-evenly items-center">
                    <PlayerBracket name="Mason" round={3} lostRound={4} />
                    <PlayerBracket name="Isaac" round={3} lostRound={3} />
                  </div>
                  <div className="w-full flex flex-col justify-evenly items-center">
                    <PlayerBracket name="Mason" round={2} lostRound={4} />
                    <PlayerBracket name="Owen" round={2} lostRound={2} />
                    <PlayerBracket name="Isaac" round={2} lostRound={3} />
                    <PlayerBracket name="Abigail" round={2} lostRound={2} />
                  </div>
                  <div className="w-full flex flex-col justify-evenly items-center">
                    <PlayerBracket name="Mason" round={1} lostRound={4} />
                    <PlayerBracket name="Caleb" round={1} lostRound={1} />
                    <PlayerBracket name="Owen" round={1} lostRound={2} />
                    <PlayerBracket name="Logan" round={1} lostRound={1} />
                    <PlayerBracket name="Zoe" round={1} lostRound={1} />
                    <PlayerBracket name="Isaac" round={1} lostRound={3} />
                    <PlayerBracket name="Gabriel" round={1} lostRound={1} />
                    <PlayerBracket name="Abigail" round={1} lostRound={2} />
                  </div>
                </div>
              </div>
            </div>
      ...
      {gameMode === "match" && !isGameRunning && gameStatus === "Begin" && (
        <div className="absolute top-0 h-screen w-screen flex flex-col items-center justify-center">
          <button
      ...
      {gameMode === "match" && gameStatus === "Stopped" && (
        ...
        <div className="flex flex-col items-center absolute left-0 right-0 top-2 lg:top-4">
          <div className="flex justify-evenly w-[200px] rounded-md border-4 opacity-90 bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-gray-900 to-gray-600 bg-gradient-to-r">
            <div className="flex flex-col text-white text-center lg:py-2">
              ...
              <p className="text-xl lg:text-3xl font-bold">{player1Score}</p>
            </div>
            <div className="flex flex-col text-white text-center lg:py-2">
              <p className="text-xs">Player 2:</p>
              <p className="text-xl lg:text-3xl font-bold">{player2Score}</p>
            </div>
          </div>
          <div className="flex justify-evenly w-[200px] text-sm lg:text-xl bg-gray-100 border-2 rounded-md">
            ...
            <div
              className={`${shotClock <= 5 ? "text-red-500" : "text-black"}`}
            >
              {shotClock}
            </div>
          </div>
