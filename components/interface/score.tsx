...
export default function Score() {
	...
	return (
		<div
			...
			className="absolute flex justify-evenly left-0 right-0 top-4 w-[200px] mx-auto rounded-md border-4 opacity-90 bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-gray-900 to-gray-600 bg-gradient-to-r"
		>
